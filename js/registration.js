...
document.getElementById('registrationForm').addEventListener('submit', function (event) {
  ...
  fetch(chechEmailApiUrl)
    ...
    .then(data => {
      ...
      registerUser(name, email, phoneNumber, password, password_confirmation, address, registerApiUrl, message);
    })
    .catch(error => {
...
function registerUser(name, email, phoneNumber, password, password_confirmation, address, registerApiUrl, message) {
